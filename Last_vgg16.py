...
if __name__ == '__main__':
    ...
    mobile_net = VGG16(input_shape=(300, 300, 3), include_top=False)
    # 固定参数
    ...
    y_pre_file = 'base5_vgg16_predict.csv'
    y_rel_file = 'base5_vgg16_reltag.csv'
    ...
    hist_csv_file = 'base5_vgg16_history.csv'
    with open(hist_csv_file, mode='w') as f:
        hist_df.to_csv(f)
    # model.save('base5_vgg16.h5')
