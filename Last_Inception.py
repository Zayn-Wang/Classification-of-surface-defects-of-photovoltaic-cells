...
if __name__ == '__main__':
    ...
    mobile_net = InceptionV3(input_shape = (300, 300, 3), include_top = False)
    # 固定参数
    ...
    y_pre_file = 'base7_InceptionV3_predict.csv'
    y_rel_file = 'base7_InceptionV3_reltag.csv'
    ...
    hist_csv_file = 'base7_InceptionV3_history.csv'
    with open(hist_csv_file, mode='w') as f:
        hist_df.to_csv(f)
    # model.save('base7_InceptionV3.h5')
